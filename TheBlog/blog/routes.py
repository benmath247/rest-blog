...
from blog.api import (CommentDestroyAPIView, CommentLikeDestroyAPIView,
                      ...
                      PostRetrieveUpdateAPIView, ReactionListAPIView)
...
urlpatterns = [
    ...
    path("posts/likes/<int:pk>/", LikeRetrieveAPIView.as_view(), name = 'like-retrieve-api-view'),
    ...
    path("posts/comments/<int:pk>/", CommentRetrieveAPIView.as_view(), name = "comment-retrieve-api-view"),
    ...
    path("posts/comments/commentlikes/<int:pk>/", CommentLikeRetrieveAPIView.as_view(), name='comment-like-retrieve-api-view'),

    path("posts/<slug:slug>/reactions/", ReactionListAPIView.as_view(), name='reaction-list-api-view')
]
